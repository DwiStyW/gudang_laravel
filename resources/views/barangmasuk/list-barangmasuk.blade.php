...
@section('content')
    ...
    <div class="row" onload="myFunction()">
        <div class="col-lg-12 margin-tb">
            <div class="card">
                <div class="card-body">
                    <a class="btn btn-success" href="barang-masuk/add"> Input Barang Masuk</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            @foreach ($riwayatmasuk as $rm)
                                <tr>
                                    ...
                                    <td>{{ $rm->statpallet }}</td>
                                    @php
                                        $sats1 = floor($rm->masuk / ($rm->max1 * $rm->max2));
                                        $sisa = $rm->masuk - $sats1 * $rm->max1 * $rm->max2;
                                    ...
                                    <td>
                                        ...
                                        <a href="barang-masuk/edit/{{ $rm->id }}" class="px-3 text-primary">
                    ...
                    {{-- <div class="w-100">
                        {{ $riwayatmasuk->onEachSide(1)->links() }}
                    </div> --}}
                </div>
            </div>
        </div> <!-- end col -->
...
@section('script')
    ...
    <script>
        ...
        function hapus(id) {
            var id = id;
            var str = '<a href="barang-masuk/delete/' + id + '" class="btn btn-md btn-success">Ya, hapus!</a>';
